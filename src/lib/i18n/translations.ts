export const translations = {
  fr: {
    ...
    blog: {
      ...
      tagline: "Un espace de réflexion spirituelle, d'actualités communautaires et d'enseignements religieux.",
      joinUs: "Rejoignez-nous dans notre voyage de foi et de découverte.",
      recentArticles: "Articles récents",
  ...
  en: {
    ...
    blog: {
      welcome: "Welcome to",
      siteName: "Sacred Blog",
      tagline: "A place for spiritual reflection, community news, and religious teachings.",
      joinUs: "Join us on our journey of faith and discovery.",
      recentArticles: "Recent Articles",
    ...
    footer: {
      description: "A place for spiritual reflection, community news, and religious teachings. Join us on our journey of faith and discovery.",
